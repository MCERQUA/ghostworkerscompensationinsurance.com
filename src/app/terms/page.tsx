...
export const metadata = {
  title: "Terms of Service | Ghost Workers Compensation Insurance",
  description:
    "Terms of service for ghostworkerscompensationinsurance.com operated by Contractors Choice Agency.",
};
            ...
            <div className="space-y-10">
              ...
              <section>
                ...
                <p className="text-[#57493f] leading-relaxed">
                  ...
                  nationwide. The Site provides information about ghost workers
                  compensation insurance, related coverage products, and allows
                  visitors to request insurance quotes and contact our agency.
                  Contractors Choice Agency is licensed in all 50 states.
                </p>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-outside ml-6 space-y-2 text-[#57493f] mb-4">
                  ...
                  <li>
                    Use automated tools, bots, or scraping software to access or
                    collect data from the Site without our prior written consent.
                  </li>
                  <li>
                  ...
                  <li>
                    Engage in any conduct that restricts or inhibits other users from
                    using or enjoying the Site.
                  </li>
                  <li>
                    Use the Site to solicit or advertise services competitive with
              ...
              <section>
                ...
                <p className="text-[#57493f] leading-relaxed mb-4">
                  ...
                  review by the applicable insurance carrier. Actual coverage terms
                ...
                <p className="text-[#57493f] leading-relaxed">
                  ...
                  professional — including our own licensed agents — to evaluate
              ...
              <section>
                ...
                <ul className="list-disc list-outside ml-6 space-y-2 text-[#57493f]">
                  ...
                  <li>
                    Acknowledge that submission of a form does not create an
                    insurance policy or guarantee coverage.
                  </li>
                  <li>
                    Acknowledge that any information you submit may be shared with
                    A-rated admitted insurance carriers for quoting purposes, as
              ...
              <section>
                ...
                <p className="text-[#57493f] leading-relaxed">
                  ...
                  display, or commercially exploit any content on this Site without
              ...
              <section>
                ...
                <ul className="list-disc list-outside ml-6 space-y-2 text-[#57493f]">
                  ...
                  <li>
                    Warranties that the Site will be uninterrupted, error-free, or
                    free of viruses or other harmful components.
                  </li>
                  <li>
                    Warranties as to the accuracy, completeness, or timeliness of
                    information provided on the Site.
                  </li>
                  <li>
                    Warranties that the Site or its content is suitable for any
                    particular purpose.
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="text-[#57493f] leading-relaxed">
                  ...
                  SITE OR ITS CONTENT, EVEN IF WE HAVE BEEN ADVISED OF THE
                  POSSIBILITY OF SUCH DAMAGES. IN NO EVENT SHALL OUR TOTAL LIABILITY
                  TO YOU FOR ALL CLAIMS RELATED TO THE SITE EXCEED ONE HUNDRED
                  DOLLARS ($100.00).
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-[#57493f] leading-relaxed">
                  ...
                  federal or state courts located in Maricopa County, Arizona, and
              ...
              <section>
                ...
                <div className="bg-[#fdfaf5] border border-[rgba(154,52,18,0.12)] rounded-xl p-6 text-sm text-[#57493f] space-y-1">
                  ...
                  <p>Governing law: State of Arizona</p>
                </div>
              </section>
