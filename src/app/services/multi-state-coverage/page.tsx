    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 hero-gradient overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div animate={{ scale: [1, 1.2, 1], opacity: [0.3, 0.5, 0.3] }} transition={{ duration: 8, repeat: Infinity }} className="absolute -top-32 -right-32 w-[500px] h-[500px] bg-[#c2410c]/10 rounded-full blur-[128px]" />
          <motion.div animate={{ scale: [1, 1.3, 1], opacity: [0.2, 0.4, 0.2] }} transition={{ duration: 10, repeat: Infinity, delay: 2 }} className="absolute -bottom-32 -left-32 w-[400px] h-[400px] bg-[#9a3412]/10 rounded-full blur-[128px]" />
        </div>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-14 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}>
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[rgba(154,52,18,0.08)] border border-[rgba(154,52,18,0.2)] mb-6">
                <Globe className="w-4 h-4 text-[#9a3412]" />
                <span className="text-xs font-bold text-[#9a3412] uppercase tracking-wider">All 50 States</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-[#2a211c] leading-[1.05] mb-5">
                Multi-State Ghost Workers Comp <span className="blue-gradient-text">Coverage</span>
              </h1>
              <p className="text-lg text-[#54463c] mb-8 leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/quote" className="flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-[#9a3412] to-[#c2410c] text-white font-bold rounded-xl shadow-xl shadow-[rgba(154,52,18,0.35)] text-lg hover:-translate-y-0.5 transition-all">
                  Get a Quote <ArrowRight className="w-5 h-5" />
                </Link>
                <a href="tel:+18449675247" className="flex items-center justify-center gap-2 px-8 py-4 bg-white text-[#9a3412] font-bold rounded-xl border-2 border-[rgba(154,52,18,0.3)] text-lg">
                  <Phone className="w-5 h-5" /> 844-967-5247
                </a>
              </div>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7, delay: 0.2 }}>
              <Image src="/images/cta-background.jpg" alt="Multi-state ghost workers comp coverage for all 50 states" width={600} height={450} className="w-full h-[420px] object-cover rounded-3xl shadow-2xl shadow-[rgba(154,52,18,0.12)]" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 className="text-4xl font-black text-[#2a211c] mb-4">What Multi-State Coverage Includes</h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              return (
                <motion.div key={item.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="card-hover bg-white rounded-2xl border border-[rgba(154,52,18,0.12)] p-7 shadow-sm">
                  <div className="w-12 h-12 rounded-xl bg-[rgba(154,52,18,0.08)] flex items-center justify-center mb-4">
                    <Icon className="w-6 h-6 text-[#9a3412]" />
                  </div>
                  <h3 className="text-lg font-black text-[#2a211c] mb-2">{item.title}</h3>
                  <p className="text-sm text-[#54463c] leading-relaxed">{item.desc}</p>
                </motion.div>
              );
            })}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-14">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <h2 className="text-3xl font-black text-[#2a211c] mb-6">Who Needs Multi-State Coverage</h2>
              <div className="space-y-4">
                {[
                  ...
                  <div key={item.title} className="flex gap-4 p-5 bg-white rounded-2xl border border-[rgba(154,52,18,0.1)] shadow-sm">
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <div className="bg-gradient-to-br from-[#9a3412] to-[#c2410c] rounded-3xl p-10 text-white">
                ...
                <div className="space-y-5">
                  {[
                    ...
                    <div key={item.title} className="flex gap-3">
                      <CheckCircle className="w-5 h-5 text-amber-200 shrink-0 mt-0.5" />
                      <div>
                ...
                <div className="mt-8 pt-6 border-t border-white/20">
                  <Link href="/quote" className="block text-center py-3 px-6 bg-white text-[#9a3412] font-bold rounded-xl hover:bg-amber-50 transition-colors">Get Multi-State Coverage Quote</Link>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-black text-[#2a211c] mb-4">Multi-State WC <span className="blue-gradient-text">FAQs</span></h2>
          </div>
          <div className="space-y-3">
            {faqs.map((faq, i) => (
              <div key={i} className="bg-[#faf8f5] rounded-2xl border border-[rgba(154,52,18,0.1)] overflow-hidden">
                <button onClick={() => setOpenFaq(openFaq === i ? null : i)} className="w-full flex items-center justify-between gap-4 p-6 text-left hover:bg-[rgba(154,52,18,0.03)] transition-colors">
                  <p className="font-bold text-[#2a211c]">{faq.q}</p>
                  <ChevronDown className={`w-5 h-5 text-[#9a3412] shrink-0 transition-transform ${openFaq === i ? "rotate-180" : ""}`} />
                </button>
                {openFaq === i && (
      ...
      <section className="py-20 bg-gradient-to-r from-[#9a3412] to-[#c2410c]">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4">Operating in Multiple States?</h2>
          <p className="text-amber-100 mb-8">Let us build you a unified multi-state WC program—one broker, all 50 states, full compliance.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/quote" className="px-8 py-4 bg-white text-[#9a3412] font-bold rounded-xl text-lg hover:bg-amber-50 transition-colors">Get a Quote</Link>
