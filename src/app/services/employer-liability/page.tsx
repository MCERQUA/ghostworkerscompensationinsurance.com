          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" animate="visible" variants={stagger}>
              ...
              >
                ...
                <span className="text-[#9a3412]">Workers Comp Part B</span>
              </motion.h1>
            ...
            >
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl shadow-xl p-4 flex items-center gap-3">
                <div className="w-10 h-10 bg-[#9a3412]/10 rounded-full flex items-center justify-center">
                  <Scale className="w-5 h-5 text-[#9a3412]" />
                </div>
                <div>
                  <p className="text-sm font-bold text-[#2a211c]">Lawsuit Defense Included</p>
                  <p className="text-xs text-stone-500">Third-party over, dual capacity & more</p>
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <motion.div
              variants={fadeUp}
              className="rounded-3xl border-2 border-stone-200 p-8 relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-extrabold text-[#2a211c] mb-4">Statutory Benefits</h3>
            ...
            <motion.div
              variants={fadeUp}
              className="rounded-3xl border-2 border-[#9a3412]/30 bg-[#faf8f5] p-8 relative overflow-hidden"
            >
              <div className="absolute top-0 right-0 w-32 h-32 bg-[#9a3412]/10 rounded-bl-full" />
              <div className="relative z-10">
                <div className="inline-flex items-center gap-2 bg-[#9a3412]/10 text-[#9a3412] px-4 py-1.5 rounded-full text-sm font-semibold mb-4">
                  <Scale className="w-4 h-4" /> Part B — Employer Liability
                </div>
                <h3 className="text-2xl font-extrabold text-[#2a211c] mb-4">Lawsuit Protection</h3>
                <p className="text-stone-600 mb-6 text-sm leading-relaxed">
                ...
                <ul className="space-y-2 mb-6">
                  {["Third-party over actions (contribution claims)", "Loss of consortium — spouse & dependent claims", "Dual capacity suits (employer as product maker)", "Consequential bodily injury to family members", "Defense costs + indemnity for covered suits"].map((item, i) => (
                    <li key={i} className="flex items-center gap-2 text-sm text-stone-700">
                      <CheckCircle className="w-4 h-4 text-[#9a3412] flex-shrink-0" /> {item}
                    </li>
                  ))}
                </ul>
                <div className="bg-[#9a3412]/10 rounded-xl p-4">
                  <p className="text-xs text-[#9a3412] font-medium">Limits elected — standard $100K/$100K/$500K; higher limits available</p>
                </div>
              </div>
            </motion.div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid md:grid-cols-2 gap-6">
            {scenarios.map((item, i) => (
              <motion.div key={i} variants={fadeUp} className="bg-white rounded-2xl p-6 border border-stone-100 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid lg:grid-cols-3 gap-6">
            {ghostScenarios.map((item, i) => (
              <motion.div key={i} variants={fadeUp} className="p-6 rounded-2xl bg-[#faf8f5] border-2 border-[#9a3412]/15 hover:border-[#9a3412]/40 transition-colors">
                <div className="w-8 h-8 bg-[#9a3412] rounded-lg flex items-center justify-center mb-4">
                  <DollarSign className="w-4 h-4 text-white" />
                </div>
                <h3 className="font-bold text-[#2a211c] mb-3">{item.title}</h3>
                <p className="text-sm text-stone-600 leading-relaxed">{item.desc}</p>
              </motion.div>
            ))}
          </motion.div>
      ...
      <section className="py-20 bg-[#faf8f5]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-12">
            <motion.h2 variants={fadeUp} className="text-3xl lg:text-4xl font-extrabold text-[#2a211c] mb-4">Standard Coverage Limits</motion.h2>
            <motion.p variants={fadeUp} className="text-stone-600 max-w-2xl mx-auto">Employer liability limits are stated in three parts — all three should be considered when selecting your coverage level.</motion.p>
          </motion.div>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {limits.map((item, i) => (
              <motion.div key={i} variants={fadeUp} className="bg-white rounded-2xl p-8 border-2 border-[#9a3412]/20 text-center shadow-sm">
                <div className="text-4xl font-extrabold text-[#9a3412] mb-2">{item.amount}</div>
                <div className="text-[#2a211c] font-bold mb-2">{item.label}</div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            variants={fadeUp}
            className="mt-8 bg-[#9a3412]/5 border border-[#9a3412]/20 rounded-2xl p-6 max-w-4xl mx-auto text-center"
          >
            <p className="text-[#2a211c] font-semibold mb-2">Higher Limits Available</p>
            <p className="text-stone-600 text-sm">
              ...
              Call CCA at <a href="tel:844-967-5247" className="text-[#9a3412] font-semibold">844-967-5247</a> to
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="text-center mb-12">
            ...
            <motion.p variants={fadeUp} className="text-stone-600">Common questions about employer liability and workers comp Part B coverage.</motion.p>
          </motion.div>
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger} className="space-y-3">
            {faqItems.map((item, i) => (
              <motion.div key={i} variants={fadeUp} className="bg-[#faf8f5] rounded-2xl border border-stone-100 overflow-hidden shadow-sm">
